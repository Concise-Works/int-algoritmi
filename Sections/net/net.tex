...
\begin{Def}[Flow Network]
    ...
    \begin{enumerate}
        ...
        \item Each edge $(u,v)$ has a capacity $c(u,v)$, which is the maximum flow that can pass through it.
    \end{enumerate}
\end{Def}
...
could use recursion finding. However, this could lead to $O(mn^2)$ time complexity, 
